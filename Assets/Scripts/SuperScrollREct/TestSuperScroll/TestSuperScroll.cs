...
public class TestSuperScroll : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SuperScrollHelper.InsCountitemWidth(_obj, superRect, item, itemNum, maxItemNum, queue, itemWidth, itemHeight,ref lastIndex);
    }

    // Update is called once per frame
    void Update()
    {
        SuperScrollHelper.OnScrollMoveWidth(scrollRectTran, superRect, item, itemNum, maxItemNum, queue, itemWidth, itemHeight, ref firstIndex, ref lastIndex,ref nowIndex,ref xPositivePosBuffer,ref xNegativePosBuffer);
